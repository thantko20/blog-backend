...
exports.signUp = [
    (0, express_validator_1.body)('username')
        ...
        return userModel_1["default"].findOne({ username: value }).then(function (user) {
            if (user) {
    ...
    (0, express_validator_1.body)('password').notEmpty().withMessage('Password should not be emtpy'),
    function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var errors, hashPassword, newUser, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, (0, bcrypt_1.genHash)(req.body.password)];
                case 2:
